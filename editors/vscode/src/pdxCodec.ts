// TypeScript twin of crates/pdx-codec (the EU4dll escape transcoder).
//
...
// emitted by `cargo run -p pdx-codec --bin pdx-codec-vectors`. Any change to
...
// --- facade used by the pdxloc:// provider -----------------------------------
