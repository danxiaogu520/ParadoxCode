...
standard LSP indentation options are accepted but ignored. Multiline Script quoted strings
whose payload parses as non-empty Script are formatted recursively because EU4 constructs can
