...
This checklist keeps the `0.x` server and editor extensions versioned as one release. GitHub
...
```bash
git tag -a v0.3.1 -m "ParadoxCode 0.3.1"
...
`v0.3.1`). This runs the current release workflow while checking out the immutable tagged source.
