...
impl SyntaxErrorKind {
    ...
    pub const fn code(self) -> &'static str {
        match self {
            Self::UnexpectedToken => "pdc-parser-unexpected-token",
            Self::MissingValue => "pdc-parser-missing-value",
            Self::UnterminatedString => "pdc-parser-unterminated-string",
            Self::UnterminatedBlock => "pdc-parser-unterminated-block",
            Self::UnterminatedParameterBlock => "pdc-parser-unterminated-parameter-block",
            Self::InvalidLocalisationEntry => "pdc-localisation-invalid-entry",
            Self::UnterminatedLocalisationString => "pdc-localisation-unterminated-string",
        }
    }
}
