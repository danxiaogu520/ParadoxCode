                ...
                match event {
                            ...
                            && !ready_logged
                        {
                            write_message(
                                ...
                                &log_message_notification(
                                    MessageType::INFO,
                                    "pdc ready — workspace indexed".to_owned(),
                                ),
                            )?;
                    ...
                    TransportEvent::ScanSetup(result) => {
                        ...
                        if !scan_is_current {
                            ...
                            // explicit `pdc/reindexWorkspace` instead of
                            ...
                            if self.scan_retries < self.scan_retry_limit {
                                ...
                                write_message(
                                    ...
                                    &show_warning_notification(
                                        "workspace kept changing during the background scan; run pdc/reindexWorkspace once editing pauses"
                                            .to_owned(),
                                    ),
                                )?;
                            }
                    ...
                    TransportEvent::DependencySetup(result) => {
                            ...
                            && !ready_logged
                        {
                            write_message(
                                ...
                                &log_message_notification(
                                    MessageType::INFO,
                                    "pdc ready — workspace, Vanilla and dependency indexes loaded"
                                        .to_owned(),
                                ),
                            )?;
                            let snapshot = self.host.snapshot();
                            ...
                            RpcError::new(
                                ...
                                match result.command {
                                    WorkspaceCommand::Reindex => {
                                        "workspace changed while reindexing; run pdc/reindexWorkspace again"
                                    }
