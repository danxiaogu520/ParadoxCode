...
//!
//! Uses the loss-aware [`parser`] CST so syntactically broken files still load:
...
pub struct LoadedFile {
    ...
    pub syntax_errors: Vec<parser::SyntaxError>,
...
fn block_scalars(parsed: &ParsedFile, block: CstNode<'_>) -> Vec<(String, text::TextRange)> {
    block
        .children()
