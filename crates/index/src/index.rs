...
use vfs::{LocalisationPreview, SourceFileId, WorkspaceError, WorkspaceScanToken};
...
impl PositionMap {
    ...
    pub fn from_grouped(grouped: BTreeMap<SourceFileId, Vec<(TextRange, PositionRange)>>) -> Self {
        let mut map = Self {
...
pub struct WorkspaceIndex {
    pub shards: BTreeMap<SourceFileId, Arc<FileIndexShard>>,
    ...
    pub position_ranges: PositionMap,
}
