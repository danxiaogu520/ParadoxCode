...
/// Usage capabilities exposed by a dynamic definition type.
#[derive(Clone, Debug, Default, Deserialize, Eq, PartialEq, Serialize)]
#[serde(deny_unknown_fields)]
pub struct DynamicDefinitionUsage {
    /// Whether the definition can be used as a replacement.
    #[serde(default, alias = "replace")]
    pub replacement: bool,
    /// Whether the definition can be used as a condition.
    #[serde(default)]
    pub condition: bool,
    /// Whether the definition can provide or consume a dynamic key.
    #[serde(default)]
    pub dynamic_key: bool,
    /// Whether the definition body or value is intentionally opaque text.
    #[serde(default)]
    pub opaque_text: bool,
}

impl DynamicDefinitionUsage {
...
/// Semantic metadata for a type whose instances are dynamic definitions.
#[derive(Clone, Debug, Default, Deserialize, Eq, PartialEq, Serialize)]
#[serde(deny_unknown_fields)]
pub struct DynamicDefinitionDescriptor {
    /// Context used to validate the definition body, for example `effect` or `trigger`.
    pub body_context: String,
    /// Whether this type instances are callable, parameterized dynamic definitions.
    #[serde(default)]
    pub enabled: bool,
    /// Context-independent usage capabilities for the definition.
    #[serde(default)]
    pub usage: DynamicDefinitionUsage,
}
...
pub struct TypeDescriptor {
    ...
    /// Optional generic dynamic-definition capabilities for this type.
    #[serde(default, skip_serializing_if = "Option::is_none")]
