//! Round-trip and validation tests for the EU4 mission model (`game::eu4::mission`).

use game::eu4::mission::{
...
fn load(source: &str) -> game::eu4::mission::MissionFile {
...
fn detects_style_from_source() {
    let style = detect_style(FIXTURE);
    assert_eq!(style.indent, game::eu4::mission::Indent::Tab);
    ...
    assert_eq!(style.indent, game::eu4::mission::Indent::Spaces(4));
